                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control celSoc" id="psn" placeholder="Identifiant Playstation Network" name="psn">
                            </div>
                        </div>
                        <div class="row form-group">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control celSoc" id="steam" placeholder="Identifiant Steam" name="steam">
                            </div>
                        </div>
                        <div class="row form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control celSoc" id="battlenet" placeholder="Identifiant Battle.net" name="battlenet">
                            </div>
                        </div>
                        <div class="row form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control celSoc" id="nintendo" placeholder="Identifiant Nintendo" name="nintendo">
                            </div>
                        </div>
                        <div class="row form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control celSoc" id="origin" placeholder="Identifiant Origin" name="origin">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control celSoc" id="linkedin" placeholder="LikedIn" name="linkedin">
                            </div>
                        </div>
                        <div class="row form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control celSoc" id="viadeo" placeholder="Viadeo" name="viadeo">
                            </div>
                        </div>
                        <div class="row form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control celSoc" id="xing" placeholder="Xing" name="xing">
                            </div>
                        </div>
                        <div class="row form-group">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control celSoc" id="facebook" placeholder="Facebook" name="facebook">
                            </div>
                        </div>
                        <div class="row form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control celSoc" id="twitter" placeholder="Twitter" name="twitter">
                            </div>
                        </div>
                        <div class="row form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control celSoc" id="youtube" placeholder="YouTube" name="youtube">
                            </div>
                        </div>
                        <div class="row form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control celSoc" id="google" placeholder="Google+" name="google">
                            </div>
                        </div>
                        <div class="row form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control celSoc" id="skype" placeholder="Skype" name="skype">
                            </div>
                        </div>
                        <div class="row form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control celSoc" id="instagram" placeholder="Instagram" name="instagram">
                            </div>
                        </div>
                        <div class="row form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control celSoc" id="pinterest" placeholder="Pinterest" name="pinterest">
                            </div>
                        </div>
                        <div class="row form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control celSoc" id="deezer" placeholder="Deezer" name="deezer">
                            </div>
                        </div>
                        <div class="row form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control celSoc" id="spotify" placeholder="Spotify" name="spotify">
                            </div>
                        </div>
                        <div class="row form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control celSoc" id="viber" placeholder="Viber" name="viber">
                            </div>
                        </div>
